...
if default_prompt_suggestions == []:
    default_prompt_suggestions = [
        {
            "title": ["گروه 1(دانش اموزان)"],
            "content": "GROUP1",
        },
        {
            "title": ["گروه 2(دانش اموزان)"],
            "content": "GROUP2",
        },
        {
            "title": ["گروه 3(دانش اموزان)"],
            "content": "GROUP3",
        },
        {
            "title": ["گروه 4(دانش اموزان)"],
            "content": "GROUP4",
        },
        {
            "title": ["گروه 5(دانش اموزان)"],
            "content": "GROUP5",
        },
        {
            "title": ["گروه 6(دانش اموزان)"],
            "content": "GROUP6",
        },
    ]
...
try:
    default_prompt_suggestions_teacher = json.loads(
        os.environ.get("DEFAULT_PROMPT_SUGGESTIONS_TEACHER", "[]")
    )
except Exception as e:
    log.exception(f"Error loading DEFAULT_PROMPT_SUGGESTIONS_TEACHER: {e}")
    default_prompt_suggestions_teacher = []
if default_prompt_suggestions_teacher == []:
    default_prompt_suggestions_teacher = [
        {
            "title": ["گروه 1(معلمان)"],
            "content": "GROUP1",
...
DEFAULT_PROMPT_SUGGESTIONS_TEACHER = PersistentConfig(
    "DEFAULT_PROMPT_SUGGESTIONS_TEACHER",
    "ui.prompt_suggestions_teacher",
    default_prompt_suggestions_teacher,
)
